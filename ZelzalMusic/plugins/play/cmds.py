...
@app.on_message(command(["قران", "القران", "الاوامر"]))
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "•˛ َِ𝗠َِ𝗥 َِ𝗟َِ𝗢َِ𝗥َِ𝗗 .•", url="https://t.me/M_r_zC"),
                ],
            ]
        ),
    )
...
async def zilzal(client: Client, message: Message):
    ...
    async for photo in client.iter_profile_photos(OWNER_ID, limit=1):
                    await message.reply_photo(photo.file_id,       caption=f"""ٴ<b>•────‌‌‏✯ 𝚀𝚄𝚁𝙰𝙽‌ ✯──‌‌‏─‌‌‏─•</b>
...
reply_markup=InlineKeyboardMarkup(
          [               
            [            
              ...
              InlineKeyboardButton("•˛ َِ𝗠َِ𝗥 َِ𝗟َِ𝗢َِ𝗥َِ𝗗 .•", url="https://t.me/M_r_zC"),
            ],
          ]
       )                 
    )                    
